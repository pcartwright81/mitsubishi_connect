"""Switch platform for mitsubishi_connect."""
...
class MitsubishiConnectSwitch(MitsubishiConnectEntity, SwitchEntity):
    """mitsubishi_connect switch class."""
